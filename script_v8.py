...
python3 script_v8.py -p0 0.5 -s 0.05 -n 5000 --nder 4 --ton 10000 --toff 10500  \
...
def main():
    ...
    argparser.add_argument("--step-script-path", type=str, default="step.py", help="Path to step.py")
    ...
    argparser.add_argument("--nreps", type=int, default=1, help="# of independent, identical replicates to run.")
    argparser.add_argument(
        "--nder", type=int, required=True, help="# of chromosomes that carry the derived allele."
    )
    argparser.add_argument("--nanc", type=int, help="# of chromosomes that carry the ancestral allele.")
    ...
    argparser.add_argument(
        ...
        type=int,
        default=500000,
        help="Position of the allele with trajectory specified by traj file.",
    )
    argparser.add_argument("--mutation-rate", type=int, default=400, help="Population-scaled mutation rate.")
